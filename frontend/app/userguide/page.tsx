  ...
  return (
    <div className="max-w-3xl mx-auto px-1 py-4">
      ...
      <section id="model" className="p-6">
        ...
        <div className="space-y-6 bg-skyblue rounded shadow-md border border-gray-200 m-4 hover:shadow-lg">
      ...
      <section className="p-6">
        ...
        <div className="space-y-6 bg-skyblue rounded shadow-md border border-gray-200 m-4 hover:shadow-lg text-black p-4">
